    ...
    <section class="login-section">
      <form action="write.php" method="post">
        <table class="table">
          ...
          <?php
          $sql_total = "SELECT COUNT(*) as total FROM board WHERE $catagory LIKE '%$search_con%'";
          ...
          $sql_search = "SELECT * FROM (SELECT TO_CHAR(BOARD_DATE, 'YYYY-MM-DD') as formatted_date, board.*, ROWNUM AS rnum FROM (SELECT * FROM board WHERE $catagory LIKE '%$search_con%' ORDER BY BOARD_DATE DESC) board WHERE ROWNUM <= $end_num) WHERE rnum >= $start_num";
